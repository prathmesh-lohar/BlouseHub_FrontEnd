  ...
  return (
    <div className="signup-outer">
      <style dangerouslySetInnerHTML={{ __html: `
        ...
        @media (min-width: 640px) { .signup-main { padding: 2rem 1.5rem; } }
        @media (min-width: 1024px) { .signup-main { padding: 1rem 1rem; } }
        ...
        @media (min-width: 1024px) { .signup-card { padding: 4rem; } }
        ...
        @media (min-width: 1024px) {
          .signup-grid { grid-template-columns: 1.05fr auto 1fr; gap: 2rem; }
        }
        ...
        .terms-row { display: flex; align-items: start; gap: 0.625rem; padding-top: 0.5rem; }
        ...
        .terms-row label { font-size: 13.5px; font-weight: 600; color: #6B5A65; cursor: pointer; line-height: 1.4; }
        .terms-row a { color: #E21761; text-decoration: none; font-weight: 600;}
        ...
        .signin-row { margin-top: 2.5rem; text-align: center; font-size: 15px; font-weight: 500; color: #444444; }
        .signin-row a { margin-left: 0.375rem; font-weight: 700; color: #E21761; text-decoration: none; }
          ...
          <div className="signup-grid">
            ...
            <div className="left-col">
              <div className="headline">
                ...
                <p>Let&apos;s get you started with your 
              ...
              <form className="signup-form" onSubmit={(e) => e.preventDefault()}>
                <div className="field">
                  ...
                  <div className="field-wrap">
                    <span className="field-icon">{formIcons.user}</span>
                ...
                <div className="field">
                  ...
                  <div className="field-wrap">
                    <span className="field-icon">{formIcons.phone}</span>
